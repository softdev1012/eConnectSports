    ...
    $.widget('rs.carousel', {
        ...
        options: {
            ...
            insertPrevAction: function () {
                return $('<a href="#" class="rs-carousel-action-prev"><i class="icon-caret-left"></i></a>').appendTo(this);
            },
            insertNextAction: function () {
                return $('<a href="#" class="rs-carousel-action-next"><i class="icon-caret-right"></i></a>').appendTo(this);
            },
            pagination: true,
